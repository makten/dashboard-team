...
namespace Dashboard.MemberManagementAPI.Events
{
    public class MemberRegistered : Event
    {
        ...
        public MemberRegistered(Guid messageId, int customerId, string salutation, TitleType title,
                                string firstName, string middleName, string lastName, DateTime dob,
